<template>
  <RightSection>
    <div class="info-desc col-lg-8">
      <h2 class="title-yellow h1 mb-3">ORACLE REP BUSINESS SOLUTIONS</h2>
      <p class="desc my-3">
    ...
    <div class="info-img col-lg-4">
      <img
        class="w-100"
        src="../../../../assets/erp/oracle-erp/patch.png"
        alt="ORACLE REP BUSINESS SOLUTIONS"
      />
    </div>
  </RightSection>
</template>
...
<script>
export default {
  name: "second-oracle-erp-section",
};
</script>
