<template>
  <LeftSection>
    <div class="info-desc col-lg-8">
      <h2 class="title-orange h1 mb-3">Private Public Cloud</h2>
      <p class="desc my-3">
    ...
    <div class="info-img col-lg-4">
      <img
        class="w-100"
        src="../../../../assets/cloud-solutions/priv-publ-cloud/patch.png"
        alt="Private Public Cloud"
      />
    </div>
  </LeftSection>
</template>
...
<script>
export default {
  name: "first-priv-publ-cloud-section",
};
</script>
