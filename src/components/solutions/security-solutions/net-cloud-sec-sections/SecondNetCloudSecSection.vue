<template>
  <RightSection>
    <div class="info-desc col-lg-8">
      <h2 class="title-yellow h1 mb-3">Network Cloud Security</h2>
      <p class="desc my-3">
    ...
    <div class="info-img col-lg-4">
      <img
        class="w-100"
        src="../../../../assets/security-solutions/network-cloud-security/patch.png"
        alt="Network Cloud Security"
      />
    </div>
  </RightSection>
</template>
...
<script>
export default {
  name: "second-network-cloud-section",
};
</script>
